...
if mp_7 == 85 // 9:
    ...
    print("Try again")
# I designated true or false as variables because it will allow for the user to input true or false themselves and I am using this the same way for the if and else statements.
# I also had the computer run the problem if you got it wrong in order to show you what it looks like.
print(Name, "you're doing great the next portion of the quiz will be true or false.")
word_true = 'true' or 'True'
word_false = 'false' or 'False'
tf_p1 = input("#8. Would the line of code" "StudyHarder!*10" "return the code StudyHarder! 10 times?")
if tf_p1 == word_true:
    print("You have big brain!")
else:
    print("StudyHarder!" * 10)
print("This is what the code would return.")
tf_p2 = input("#9. Would the line of code" "Happy" + "Birthday!" "return the code Happy + Birthday?")
if tf_p1 == word_false:
...
if tf_p3 == word_false:
    ...
    print(10 != 10)
    print("This is what the outcome should be and why you got it wrong is because the != is when not equal")
tf_p4 = input("#11. Would the line of code 10>=1 come back as true or false?")
if tf_p4 == word_false:
    print("You have big brain!")
else:
    print(10 >= 1)
    print("This is what the outcome should be and why you got it wrong is because the >= is greater than or equal too")
print(
    "The next part of the quiz is going to be is typing a number that is going to make the statement true, if you get a false then it is incorrect!!!!")
print("#12. What is a number that makes this statement true: numPeople>20 and numPeople<45 ?")
numPeople = int(input("number:"))
print(numPeople > 20 and numPeople < 45)
print("#13. What is a number that makes this statement true: numDogs<30 or numDogs>45 ?")
numDogs = int(input("number:"))
print(numDogs < 30 or numDogs > 45)
print("#14. What is a number that makes this statement true: not(numberUmbrellas*5==100) ?")
...
while True:
    try:
        m_7 = str(input("#16. 20 and 30 are not equal, would you use =! to code that?"))
        if m_7 != word_false:
...
while True:
    try:
        m_11 = int(input("#20. what number plus another number does not equals the first number"))
        total = 0
        for x in range(2):
...
while True:
    try:
        m_12 = int(input("#21.if i gave you x= range (3,6) how many lines would the output have"))
        x = range(1, 2)
        for n in x:
            if m_12 == 3:
                print('mice are nice')
